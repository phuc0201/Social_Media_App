 ...
 */
abstract class Hilt_NewPostFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewPostFragment() {
    super();
  }

  Hilt_NewPostFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewPostFragment_GeneratedInjector) this.generatedComponent()).injectNewPostFragment(UnsafeCasts.<NewPostFragment>unsafeCast(this));
    }
  }
