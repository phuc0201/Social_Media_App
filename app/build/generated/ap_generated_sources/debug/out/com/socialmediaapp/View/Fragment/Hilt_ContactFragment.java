 ...
 */
abstract class Hilt_ContactFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ContactFragment() {
    super();
  }

  Hilt_ContactFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ContactFragment_GeneratedInjector) this.generatedComponent()).injectContactFragment(UnsafeCasts.<ContactFragment>unsafeCast(this));
    }
  }
