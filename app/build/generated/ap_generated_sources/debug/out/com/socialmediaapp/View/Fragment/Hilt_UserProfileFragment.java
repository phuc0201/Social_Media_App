 ...
 */
abstract class Hilt_UserProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserProfileFragment() {
    super();
  }

  Hilt_UserProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserProfileFragment_GeneratedInjector) this.generatedComponent()).injectUserProfileFragment(UnsafeCasts.<UserProfileFragment>unsafeCast(this));
    }
  }
