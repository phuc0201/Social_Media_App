 ...
 */
abstract class Hilt_FeedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FeedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeedFragment_GeneratedInjector) this.generatedComponent()).injectFeedFragment(UnsafeCasts.<FeedFragment>unsafeCast(this));
    }
  }
