 ...
 */
abstract class Hilt_AddFriendFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddFriendFragment() {
    super();
  }

  Hilt_AddFriendFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddFriendFragment_GeneratedInjector) this.generatedComponent()).injectAddFriendFragment(UnsafeCasts.<AddFriendFragment>unsafeCast(this));
    }
  }
