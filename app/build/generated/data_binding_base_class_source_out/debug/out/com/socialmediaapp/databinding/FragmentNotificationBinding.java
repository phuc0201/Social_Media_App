...
public final class FragmentNotificationBinding implements ViewBinding {
  ...
  private FragmentNotificationBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView rcvNotification) {
    this.rootView = rootView;
    this.rcvNotification = rcvNotification;
  }
  ...
  public static FragmentNotificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rcv_notification;
      RecyclerView rcvNotification = ViewBindings.findChildViewById(rootView, id);
      if (rcvNotification == null) {
        break missingId;
      }

      return new FragmentNotificationBinding((FrameLayout) rootView, rcvNotification);
    }
